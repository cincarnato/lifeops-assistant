...
import AgentJobExecutionCrud from '../cruds/AgentJobExecutionCrud'
...
const entityName = AgentJobExecutionCrud.instance.name
...
<template>
  ...
  <crud-autocomplete
    v-model="valueModel"
    :field="field"
    :entity="AgentJobExecutionCrud.instance"
    :hint="hint"
