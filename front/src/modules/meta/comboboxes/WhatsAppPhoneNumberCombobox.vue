...
import WhatsAppPhoneNumberCrud from '../cruds/WhatsAppPhoneNumberCrud'
...
const entityName = WhatsAppPhoneNumberCrud.instance.name
...
<template>
  ...
  <crud-autocomplete
    v-model="valueModel"
    :field="field"
    :entity="WhatsAppPhoneNumberCrud.instance"
    :hint="hint"
