...
const WhatsAppWebhookEventSchema = new mongoose.Schema<IWhatsAppWebhookEvent>({
            ...
            phoneNumberRef: {type: mongoose.Schema.Types.ObjectId, ref: 'WhatsAppPhoneNumber',  required: false, index: true, unique: false },
            ...
            processingStatus: {type: String,  enum: ['PENDING', 'PROCESSING', 'PROCESSED', 'IGNORED', 'ERROR'], required: true, index: true, unique: false, default: 'PENDING' },
